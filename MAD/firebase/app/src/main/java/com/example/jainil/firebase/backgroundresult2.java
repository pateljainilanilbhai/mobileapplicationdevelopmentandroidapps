...
public class backgroundresult2 extends Service {
    String username;
    String companyname;
    String round;
    public backgroundresult2() {
...
//        Toast.makeText(this, username+" "+companyname+" "+round+" OK", Toast.LENGTH_LONG).show();
        ...
        qq.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (e.getRound2result().equals("Pass")) {
                    NotificationHelper helper = new NotificationHelper(backgroundresult2.this);
                    helper.createNotification("Charusat", "Congratulation You have passed round " + round + " of " + companyname);
                    stopSelf();
                }
//                if (round.equals("3") && e.getRound3result().equals("Pass")) {
//                    NotificationHelper helper = new NotificationHelper(backgroundresult.this);
//                    helper.createNotification("Charusat", "Congratulation You have passed round " + round + " of " + companyname);
//                    stopSelf();
//                }
